            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6  lg:px-8 ">
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                    <div className='lg:col-span-3'>
                        <form className='bg-white px-6 py-12 mt-12'>
                            <div className="space-y-12">
                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <ul role="list" >
                                        {address.map((person) => (
                                            <li key={person.name} className="flex border-solid px-5 border-2 border-gray justify-between gap-x-6 py-5">
                                                <div className="">
                                                    <input
                                                        name='address'
                                                        type="radio"
                                                ...
                                                <div className=" sm:flex sm:flex-col sm:items-end">
                                                    <p className="text-sm leading-6 text-gray-700">Phone : {person.phone}</p>
                    ...
                    <div className='lg:col-span-2'>
                        <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="mt-8  border-t border-gray-200 px-4 py-6 sm:px-6">
                                <h2 className='text-3xl my-5 font-bold tracking-tight text-gray-900'>Cart</h2>
